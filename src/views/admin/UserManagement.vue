    ...
    <v-row class="mb-4">
      <v-col>
        <div class="d-flex align-center">
          <v-icon size="32" color="primary" class="mr-3">mdi-account-multiple</v-icon>
          <div>
            <h1 class="text-h4 font-weight-bold text-primary">Manajemen User</h1>
            <p class="text-body-1 text-grey-darken-1 mb-0">Kelola pengguna sistem kasir</p>
          </div>
        </div>
      </v-col>
      <v-col cols="auto">
    ...
    <v-dialog v-model="deleteDialog" max-width="400px">
      <v-card>
        ...
        <v-card-text class="pa-4">
          <p>Apakah Anda yakin ingin menghapus user <strong>{{ selectedUser?.nama }}</strong>?</p>
